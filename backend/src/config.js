...
const config = {
  ...
  trading: {
    maxBuyPriceEth: parseFloat(process.env.MAX_BUY_PRICE_ETH || '0.1'),
    minProfitMargin: parseFloat(process.env.MIN_PROFIT_MARGIN || '0.15'),
  ...
  scanner: {
    ...
    maxFloorPrice: parseFloat(process.env.MAX_FLOOR_PRICE || '5.0'),
  },
  server: {
